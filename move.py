...
# MOUVEMENT LEFT
def left(rubik):
    utils.swap(rubik, [0,44,45,18])
    utils.swap(rubik, [3,41,48,21])
    utils.swap(rubik, [6,38,51,24])
    utils.swap(rubik, [15,17,11,9])
    utils.swap(rubik, [12,16,14,10])

def left_rev(rubik):
    utils.swap(rubik, [18,45,44,0])
    utils.swap(rubik, [21,48,41,3])
    utils.swap(rubik, [24,51,38,6])
    utils.swap(rubik, [9,11,17,15])
    utils.swap(rubik, [10,14,16,12])
